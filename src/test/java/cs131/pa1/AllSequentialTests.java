...
public class AllSequentialTests {
	...
	public static void setUp() {
		...
		createFile("fizz-buzz-9.txt", generateFizzBuzz(9)); // Used by head, tail tests b/c I wanted file that has exactly 10 lines.
		...
		createFile("dir1/dir2/f2.txt",
				"FILE 2\nTHIS IS THE SECOND FILE.\nIT IS PRETTY SIMILAR\nI HOPE YOU LIKE IT\n\n\nDO YOU????");
		createFile("dir1/dir2/dir3/dir4/f4.txt",
	...
	public static void tearDown() throws Exception {
		if (!AllSequentialTests.DEBUGGING_MODE) {
			String[] files = { "folder-contents.txt", "hello.txt", "hello2.txt", "world.txt", "hello-world.txt",
					"fizz-buzz-100.txt", "fizz-buzz-10000.txt", "fizz-buzz-1500000.txt", "replTest1.txt",
					"replTest2.txt", "replTest3.txt", "ascii.txt", "empty.txt", "pi.txt", "fizz-buzz-10.txt", "fizz-buzz-9.txt" };
